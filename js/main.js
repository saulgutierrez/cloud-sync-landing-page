...
const navFigure = document.querySelector('.nav__figure');
...
navButton.addEventListener('click', ()=>{
    ...
    if(navMenu.classList.contains('nav__container--active')){
        ...
        navLogo.setAttribute('src', './images/logo-cloud.png');
        navButton.setAttribute('src', '././images/icon-close.svg');
        navFigure.classList.add('nav__logo__color');

    }else{

        navLogo.setAttribute('src', './images/logo-cloud.png');
        navButton.setAttribute('src', '././images/icon-hamburger.svg');
        navFigure.classList.remove('nav__logo__color');
